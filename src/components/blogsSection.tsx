            ...
            <SwiperSlide key={idx}>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-between w-full h-full p-6">
                  <div>
                    <span className="block text-md tracking-widest text-black/80 mb-2">
                      {item.date}
                    </span>
                    <h3 className="text-lg mt-4 font-normal text-black  leading-snug">
                      {item.title}
                    </h3>
                  </div>
