...
const HeroSlider = () => {
    ...
    const slides = [
        ...
        },
        {
            ...
            thumbTitle: t('slides.3.thumbTitle')
        },
    ];
                ...
                >
                    {slides.map((slide, index) => (
                        <SwiperSlide key={slide.id} className="relative h-full w-full px-4 md:px-20">
                            ...
                            <div
                                className="absolute bottom-[25%] z-10 flex flex-col justify-evenly gap-2 items-start w-full text-white max-w-[1000px]"
                                    ...
                                    {activeIndex === index && (
                                        <>
                                            ...
                                            <motion.h2
                                                ...
                                                className="text-4xl md:text-5xl font-bold mb-6 max-w-[400px] md:max-w-none"
                                            >
                                                {slide.title}
                                            </motion.h2>
                                            <motion.a
