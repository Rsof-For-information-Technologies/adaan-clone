                                    ...
                                    >
                                        <div className="relative z-10 w-full">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    <div className="bg-white/20 w-fit backdrop-blur-sm rounded-2xl px-4 py-2 border border-white/30 mb-2">
                                                        <span className={`text-2xl font-bold ${item.textColor}`}> {item.date} </span>
                                                    </div>
