...
export default function MainHeader () {
    ...
    return (
        <header className="bg-[#ffffff]">
            <AnnouncementBar />
            <div className="max-w-[1400px] mx-auto px-6 h-18 md:h-24 flex items-center justify-between text-black">
                        ...
                        <ul className="flex items-center gap-8">
                            {navItems.map((item) => (
                                <li key={item.href}>
                                    <Link
                                        href={item.href}
                                        className="uppercase tracking-wide text-sm font-semibold text-black transition-all duration-200 hover:text-[#13A7DC] relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[0.3px] after:bg-[#13A7DC] after:transition-all after:duration-400 hover:after:w-full"
                                    >
                                        {item.label}
                                    </Link>
                                </li>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex items-center justify-between pt-8 border-t border-white/10">
                            <div className="flex items-center gap-4">
                                <Link href="/ar" className="text-sm font-medium text-white/70 hover:text-white transition-colors">{t("language.arabic")}</Link>
                                <span className="text-white/30">|</span>
                                <Link href="/en" className="text-sm font-medium text-white hover:text-white/70 transition-colors">{t("language.english")}</Link>
                            </div>
