...
const AnnouncementBar = () => {
    return (
        <div className="hidden md:block bg-black/40 text-white/80 w-full">
            <div className="max-w-[1400px] mx-auto p-6 py-2 flex items-center justify-between text-[13px]">
                <div className="flex items-center gap-3">
                    <Link href="/ar" className="hover:text-white">العربية</Link>
                    <span className="opacity-60">|</span>
                    <span className="text-blue-400 text-xs">English</span>
                    <Link href="/en/global-contacts" className="hover:text-white ml-6">
                        Global contacts
                    </Link>
                </div>
                <div className="flex items-center gap-6">
                    ...
                    >
                        <span>You are in Adaan Global</span>
